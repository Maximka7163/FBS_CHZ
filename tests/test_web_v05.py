...
def test_capabilities_writes_disabled(env):
 c,_=env;auth(c);assert c.get("/api/capabilities").json()=={"true_api":"mock","true_api_write":False,"document_signing":False,"submission":False,"windows_bridge":False,"registration":False}
