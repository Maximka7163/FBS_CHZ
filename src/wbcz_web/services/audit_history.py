...
_EVENT_DEFINITIONS = [
    ...
    _ev("REPORT_DOWNLOAD_DENIED", AuditCategory.REPORT, "DOWNLOAD_DENIED", [U,S], [SubjectType.REPORT_ARTIFACT], TenantRequirement.ORGANISATION, snapshot=True),
    ...
    _ev("REPORT_ARTIFACT_INTEGRITY_FAILED", AuditCategory.REPORT, "ARTIFACT_INTEGRITY_FAILED", [U,W,S], [SubjectType.REPORT_ARTIFACT], TenantRequirement.ORGANISATION, snapshot=True),
